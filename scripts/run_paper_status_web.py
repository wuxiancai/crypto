...
def _backtest_config_from_query(query: dict[str, list[str]]) -> StrategyBacktestConfig:
    ...
    return StrategyBacktestConfig(
        ...
        daily_exit_policy=_query_choice(
            query,
            "daily_exit_policy",
            "FULL_REVERSAL",
            {"FULL_REVERSAL", "NONE"},
        ),
        h4_rebound_adx_block_threshold=_query_decimal(
            query,
            "h4_rebound_adx_block_threshold",
            Decimal("20"),
            minimum=Decimal("0"),
            maximum=Decimal("80"),
        ),
        stop_atr_multiplier=_query_decimal(
            query,
            "stop_atr_multiplier",
            Decimal("1.5"),
            minimum=Decimal("0.5"),
...
def _batch_config_from_query(query: dict[str, list[str]]):
    ...
    return StrategyBacktestBatchConfig(
        ...
        target_risk_rewards=_query_decimal_list(
            query,
            "target_risk_rewards",
            ("2",),
            minimum=Decimal("0.5"),
        ...
        daily_exit_policies=_query_choice_list(query, "daily_exit_policies", ("FULL_REVERSAL",), {"FULL_REVERSAL", "NONE"}),
        h4_rebound_adx_block_thresholds=_query_decimal_list(
            query,
            "h4_rebound_adx_block_thresholds",
            ("20",),
            minimum=Decimal("0"),
            maximum=Decimal("80"),
        ),
        stop_atr_multipliers=_query_decimal_list(
            query,
