...
- 2026-06-30 已将 `交易逻辑优化.md` 重写并继续完善为“大防线 / 仓位层级”设计草案：周线既是趋势状态也是核心仓位层，日线是在周线环境下的反弹或顺势战术仓，4H 只作为严格执行层；文档已补充仓位身份表、冲突处理、禁止交易状态、风险预算优先级和后续细化顺序，后续落地前仍需继续量化死叉、反弹失败、BOLL 开口、结构突破、周线 MA60 防线减仓和周线金叉确认。
