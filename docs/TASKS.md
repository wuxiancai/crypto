...
- 2026-06-24 策略回测页面已新增“参数组合对比”表，复用最近回测归档并按账户权益从高到低排序，便于横向比较均线、ATR、DMI、Swing、手续费/风险、周期、净盈亏、胜率、盈亏比、最大回撤和交易次数。
...
- 待做：策略回测继续补充更细的参数组合对比维度，例如最大回撤、盈亏比和按 strategy bucket 展开的组合对比。
